...
public class RedisUtil {
	...
	// Redis服务器IP
	public static String ADDR_ARRAY = "";
	// Redis的端口号
	 ...
	 * @param value
	 */
	public static void setString(byte[] key, int seconds, byte[] value, int dbIndex) {
		try {
	 ...
	 * @return value
	 */
	public static String getString(String key, int selectIndex) {
		Jedis jedis = getJedis();
		if (jedis == null) {
			return null;
		}
	 ...
	 * @return value
	 */
	public static byte[] getByte(byte[] key, int selectIndex) {
		Jedis jedis = getJedis();
		if (jedis == null) {
			return null;
		}
